...
if ($home===true) {
	...
	$query="SELECT DATE_FORMAT(timestamp, '%W %H:%i') as timestamp,consumption,solar,alwaysOn,gridImport,gridExport,selfConsumption,selfSufficiency from `smappee_kwartaal` ORDER BY timestamp ASC";
