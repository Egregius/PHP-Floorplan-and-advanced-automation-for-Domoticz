...
if ($d['living_set']['m']==0) {
	if ($d['buiten_temp']['s']<20&&$d['minmaxtemp']['m']<20&&$d['heating']['s']>=1&&$d['raamliving']['s']=='Closed'&&$d['deurinkom']['s']=='Closed'&&$d['deurgarage']['s']=='Closed') {
		$Setliving=16;
		if ($d['Weg']['s']==0) {
			if (TIME>=strtotime('17:30')&&TIME<strtotime('19:00')) $Setliving=21.0;
			elseif (TIME>=strtotime('17:00')&&TIME<strtotime('19:00')) $Setliving=20.9;
			elseif (TIME>=strtotime('16:00')&&TIME<strtotime('19:00')) $Setliving=20.8;
			elseif (TIME>=strtotime('15:00')&&TIME<strtotime('19:00')) $Setliving=20.7;
			elseif (TIME>=strtotime('14:00')&&TIME<strtotime('19:00')) $Setliving=20.6;
