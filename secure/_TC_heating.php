...
$lastautosetliving ??= 0;
if($d['living_set']->m==0&&$d['weg']->s==2&&$d['heating']->s==1&&$d['living_temp']->s<=21.5) {
	if($d['n']<0&&$d['b']>=0&&$d['c']>=70) $Setliving=22;
	elseif($d['n']<-200&&$d['b']>=0&&$d['c']>=50) $Setliving=22;
	elseif($d['n']<-400&&$d['b']>=0&&$d['c']>=30) $Setliving=22;
