...
<html manifest="floorplan.appcache">';
    ...
    <script type=\'text/javascript\'>
        ...
        $(document).ready(function(){floorplan();});
    </script>';
    }
    echo '
	</head>';
...
function handlerequest()
{
    if (isset($_REQUEST['rollers'])) {
        handlerollers();
    } elseif (isset($_REQUEST['Roller'])) {
        handleroller();
    } elseif (isset($_REQUEST['verdieping'])) {
        handleverdieping();
    } elseif (isset($_REQUEST['luifel'])) {
        handleluifel();
    } elseif (isset($_REQUEST['heating'])) {
        handleheating();
...
<body>
    <div class="fix dimmer" >
        <form method="POST" action="floorplan.php" oninput="level.value = Rollerlevel.valueAsNumber">
