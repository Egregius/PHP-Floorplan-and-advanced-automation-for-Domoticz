...
if ($d['weg']['s']<2&&$d['n']<-1200&&$d['b']>0&&$d['grohered']['s']=='Off') sw('grohered', 'On', basename(__FILE__).':'.__LINE__.' n='.$d['n'].'W', true);
elseif ($d['grohered']['s']=='On'&&past('8keuken_8')>1800&&$d['n']>100) sw('grohered', 'Off', basename(__FILE__).':'.__LINE__.' n='.$d['n'].'W',true);
