...
$user='cron10';
apcu_store('d',$time);
addSample($rollingBuffers, 'n', $d['n']);
...
//	} elseif(($d['dag']->s>-3||$d['rliving']->s>50)&&$d['tuintafel']->s=='On') sw('tuintafel','Off');
...
elseif ($d['grohered']->s=='On' &&  $d['wasbak']->s==0 && $d['snijplank']->s==0 && past('8keuken_8')>1800 && (
        $d['a']>1000
        || (rollingAbove('n', 100, $offWindow) || rollingAbove('n', 1000, 30, 3))
