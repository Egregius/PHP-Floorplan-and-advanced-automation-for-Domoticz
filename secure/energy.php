...
while (true) {
    ...
    if ($currentHour === 23 && $currentMin === 59 && $lastDayUpdate !== $currentDay) {
        $force = true;
...
function updateVerbruikCache($newData, $force = false, $thresholds = ['energy_import'=>0.001,'energy_export'=>1,'gas'=>0.1,'water'=>0.01]) {
