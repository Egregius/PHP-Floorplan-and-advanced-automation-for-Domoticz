	...
	if ($d['buiten_temp']['s']<20&&$d['minmaxtemp']['m']<20&&$d['heating']['s']>=1&&$d['raamliving']['s']=='Closed'&&$d['deurinkom']['s']=='Closed'&&$d['deurgarage']['s']=='Closed') {
		...
		if ($d['Weg']['s']==0) {
			...
			if($dow==0||$dow==6) {
				...
				elseif (TIME>=strtotime('6:45')&&TIME<strtotime('12:00')) $Setliving=19.5;
				elseif (TIME>=strtotime('6:30')&&TIME<strtotime('12:00')) $Setliving=19.0;
				elseif (TIME>=strtotime('6:15')&&TIME<strtotime('12:00')) $Setliving=18.5;
				elseif (TIME>=strtotime('6:00')&&TIME<strtotime('12:00')) $Setliving=18.0;
				elseif (TIME>=strtotime('5:45')&&TIME<strtotime('12:00')) $Setliving=17.5;
				elseif (TIME>=strtotime('5:30')&&TIME<strtotime('12:00')) $Setliving=17.0;
				elseif (TIME>=strtotime('5:15')&&TIME<strtotime('12:00')) $Setliving=16.5;
				elseif (TIME>=strtotime('5:00')&&TIME<strtotime('12:00')) $Setliving=16.0;
				elseif (TIME>=strtotime('4:45')&&TIME<strtotime('12:00')) $Setliving=15.5;
				elseif (TIME>=strtotime('4:30')&&TIME<strtotime('12:00')) $Setliving=15.0;
				elseif (TIME>=strtotime('4:15')&&TIME<strtotime('12:00')) $Setliving=14.5;
				elseif (TIME>=strtotime('4:00')&&TIME<strtotime('12:00')) $Setliving=14.0;
			} else {
				if (TIME>=strtotime('6:00')&&TIME<strtotime('12:00')) $Setliving=20.0;
				elseif (TIME>=strtotime('5:45')&&TIME<strtotime('12:00')) $Setliving=19.5;
				elseif (TIME>=strtotime('5:30')&&TIME<strtotime('12:00')) $Setliving=19.0;
				elseif (TIME>=strtotime('5:15')&&TIME<strtotime('12:00')) $Setliving=18.5;
				elseif (TIME>=strtotime('5:00')&&TIME<strtotime('12:00')) $Setliving=18.0;
				elseif (TIME>=strtotime('4:45')&&TIME<strtotime('12:00')) $Setliving=17.5;
				elseif (TIME>=strtotime('4:30')&&TIME<strtotime('12:00')) $Setliving=17.0;
				...
				elseif (TIME>=strtotime('3:45')&&TIME<strtotime('12:00')) $Setliving=15.5;
				elseif (TIME>=strtotime('3:30')&&TIME<strtotime('12:00')) $Setliving=15.0;
				elseif (TIME>=strtotime('3:15')&&TIME<strtotime('12:00')) $Setliving=14.5;
...
if ($d['auto']['s']=='On'&&$d['Weg']['s']<3) {
	...
	elseif (TIME>=strtotime('15:00')&&TIME<strtotime('17:00')) {
		if ($d['buiten_temp']['s']<10) {
			...
			foreach ($items as $i) {
				if ($d['raam'.$i]['s']=='Open'&&$d[$i.'_temp']['s']<16&&past('raam'.$i)>14400&&$d['R'.$i]['s']<60) {
					sl('R'.$i, 100, basename(__FILE__).':'.__LINE__);
				}
			}
			$items=array('kamerL', 'kamerR');
			foreach ($items as $i) {
				if ($d['raamkamer']['s']=='Open'&&$d['kamer_temp']['s']<16&&past('raamkamer')>14400&&$d['R'.$i]['s']<60) {
					sl('R'.$i, 100, basename(__FILE__).':'.__LINE__);
				}
			}
		}
