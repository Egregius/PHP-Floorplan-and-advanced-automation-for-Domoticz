...
if ($d['daikinliving']['m']==0&&$d['daikinkamer']['m']==0&&$d['daikinalex']['m']==0) {
	...
	if ($d['daikin']['s']=='On'&&$d['daikin']['m']==1&&$usage[0]<12&&past('daikin')>1800&&past('daikinliving')>1800&&past('daikinkamer')>1800&&past('daikinalex')>1800) sw('daikin', 'Off', basename(__FILE__).':'.__LINE__);
} else {
