...
if ($status=='On'&&$d['deurvoordeur']->s=='Closed') {
	...
	if ($time>getCache('ring_ding')+30) {
		if ($d['deurvoordeur']->s=='Closed') {
			...
			if ($d['weg']->s==0) {
				if (($d['bose101']->s=='On'||$d['bose102']->s=='On'||$d['bose103']->s=='On'||$d['bose104']->s=='On'||$d['bose105']->s=='On'||$d['bose106']->s=='On'||$d['bose107']->s=='On'||$d['bose108']->s=='On'||$d['bose109']->s=='On')&&$d['pirliving']->s=='Off'&&$d['pirkeuken']->s=='Off') {
