...
if (isset($argv[1])) {
	...
	if (in_array('cron120', $cron)) include '_cron120.php';
	if (in_array('cron180', $cron)) include '_cron180.php';
	if (in_array('cron240', $cron)) include '_cron240.php';
	if (in_array('cron300', $cron)) {
		include '_cron300.php';
	    include 'gcal/gcal.php';
	    include 'gcal/tobibeitem.php';
	    include 'gcal/mirom.php';
	}
	if (in_array('cron3600', $cron)) include '_cron3600.php';
}