...
function huisslapen() {
	...
	sw(array('garageled','garage','pirgarage','pirkeuken','pirliving','pirinkom','pirhall','kristal','bureel','jbl','tuin','snijplank','zolderg','voordeur','wc','dampkap','GroheRed','kookplaatpower','nvidia','kenwood'), 'Off', basename(__FILE__).':'.__LINE__);
