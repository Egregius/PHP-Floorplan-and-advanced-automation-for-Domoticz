...
function huisslapen() {
	...
	sw(array('garageled','garage','pirgarage','pirkeuken','pirliving','pirinkom','pirhall','media','bureel','jbl','tuin','keuken','zolderg','voordeur','wc','dampkap','GroheRed','kookplaatpower'), 'Off', basename(__FILE__).':'.__LINE__);
