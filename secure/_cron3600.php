...
//RefreshZwave(128);
if ($d['buiten_temp']['s']<4&&$d['heating']['s']<4&&past('heating')>43200) store('heating', 4, basename(__FILE__).':'.__LINE__);
elseif ($d['buiten_temp']['s']>10&&$d['heating']['s']>1&&past('heating')>43200) store('heating', 1, basename(__FILE__).':'.__LINE__);
