...
$mqtt = new MqttClient('127.0.0.1',8081, 'test_client');
$connectionSettings = (new ConnectionSettings())->setUseTls(false);
$mqtt->connect($connectionSettings, true);

//$mqtt=new MqttClient('ws://127.0.0.1:8081',8081,'mqttrepublishdomoticz');
//$connectionSettings=(new ConnectionSettings())
//	->setKeepAliveInterval(30)
//	->setUseTls(false);
//$mqtt->connect($connectionSettings, false, 4, 3); // protocol en transport protocol worden hier meegegeven.
