...
if ((TIME>=strtotime('11:00')&&TIME<strtotime('20:00'))||$battery<50) {
	if (($d['ringdoorbell']['s']=='Off'&&past('ringdoorbell')>28800)||$battery<50) sw('ringdoorbell', 'On', basename(__FILE__).':'.__LINE__.' battery='.$battery);
