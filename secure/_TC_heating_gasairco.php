...
elseif ($difgas<=-0.4&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.9&&$d['n']>-500&&$d['buiten_temp']['s']<=1) sw('brander','On' , 'Aan na = '.$aanna*0.9);
elseif ($difgas<=0.2   &&$d['brander']['s']=="Off"&&$pastbrander>$aanna    &&$d['n']>-500&&$d['buiten_temp']['s']<=0) sw('brander','On' , 'Aan na = '.$aanna);
