...
if (	$difgas<=-0.2&&$d['brander']['s']=="Off"&&past('brander')>$aanna*0.6) sw('brander','On' , 'Aan na = '.$aanna*0.6.' '.basename(__FILE__).':'.__LINE__);
elseif ($difgas<=-0.1&&$d['brander']['s']=="Off"&&past('brander')>$aanna*0.8) sw('brander','On' , 'Aan na = '.$aanna*0.8.' '.basename(__FILE__).':'.__LINE__);
elseif ($difgas<=0   &&$d['brander']['s']=="Off"&&past('brander')>$aanna)     sw('brander','On' , 'Aan na = '.$aanna.' '.basename(__FILE__).':'.__LINE__);
...
//	}
	$net=mget('net');
	if ($net>5000&&$maxpow>40) $maxpow=40;
	elseif ($net>4500&&$maxpow>50) $maxpow=50;
	elseif ($net>4000&&$maxpow>60) $maxpow=60;
	elseif ($net>3500&&$maxpow>70) $maxpow=70;
	elseif ($net>3000&&$maxpow>80) $maxpow=80;
	foreach (array('living', 'kamer', 'alex') as $k) {
		if ($d[$k.'_set']['s']>10) {
