...
if (	$difgas<=-1.8&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.5&&$d['n']>-500&&$d['buiten_temp']['s']<=5) sw('brander','On' , 'Aan na = '.$aanna*0.5);
elseif ($difgas<=-1.5&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.6&&$d['n']>-500&&$d['buiten_temp']['s']<=4) sw('brander','On' , 'Aan na = '.$aanna*0.6);
elseif ($difgas<=-1.2&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.7&&$d['n']>-500&&$d['buiten_temp']['s']<=3) sw('brander','On' , 'Aan na = '.$aanna*0.7);
elseif ($difgas<=-0.9&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.8&&$d['n']>-500&&$d['buiten_temp']['s']<=2) sw('brander','On' , 'Aan na = '.$aanna*0.8);
elseif ($difgas<=-0.6&&$d['brander']['s']=="Off"&&$pastbrander>$aanna*0.9&&$d['n']>-500&&$d['buiten_temp']['s']<=1) sw('brander','On' , 'Aan na = '.$aanna*0.9);
elseif ($difgas<=0.3   &&$d['brander']['s']=="Off"&&$pastbrander>$aanna    &&$d['n']>-500&&$d['buiten_temp']['s']<=0) sw('brander','On' , 'Aan na = '.$aanna);
