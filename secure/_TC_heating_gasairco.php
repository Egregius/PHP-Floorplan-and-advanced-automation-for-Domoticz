...
//	lg($k.' corr='.$corr.' set='.$set.' temp='.$d[$k.'_temp']['s']);
	...
	if ($d[$k.'_set']['s']>10) {
		...
		elseif (${'dif'.$k}>=-0.4)	{$power=1;$set=$d[$k.'_set']['s']+0.5;}
		elseif (${'dif'.$k}>=-0.5)	{$power=1;$set=$d[$k.'_set']['s']+1;}
		elseif (${'dif'.$k}>=-0.6)	{$power=1;$set=$d[$k.'_set']['s']+1.5;}
		elseif (${'dif'.$k}>=-0.7)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-0.8)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-0.9)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-1.0)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-1.1)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-1.2)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-1.3)	{$power=1;$set=$d[$k.'_set']['s']+2;}
		elseif (${'dif'.$k}>=-1.4)	{$power=1;$set=$d[$k.'_set']['s']+3;}
		elseif (${'dif'.$k}>=-1.5)	{$power=1;$set=$d[$k.'_set']['s']+3;}
		elseif (${'dif'.$k}>=-1.6)	{$power=1;$set=$d[$k.'_set']['s']+3;}
		elseif (${'dif'.$k}>=-1.7)	{$power=1;$set=$d[$k.'_set']['s']+3;}
		elseif (${'dif'.$k}>=-1.8)	{$power=1;$set=$d[$k.'_set']['s']+3;}
		elseif (${'dif'.$k}>=-1.9)	{$power=1;$set=$d[$k.'_set']['s']+3;}
