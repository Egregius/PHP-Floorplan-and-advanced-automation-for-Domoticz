...
var settings = {
	...
	time_ul_max: 1, // max duration of upload test in seconds
	time_dl_max: 180, // max duration of download test in seconds
	...
	garbagePhp_chunkSize: 10000, // size of chunks sent by garbage.php (can be different if enable_quirks is active)
