...
session_write_close();
if (isset($_REQUEST['device'])&&$_REQUEST['device']=='runsync'&&$_REQUEST['command']=='runsync') exec('curl -s http://192.168.20.20/secure/runsync.php?sync='.$_REQUEST['action'].' &');
