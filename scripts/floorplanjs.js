...
function weg(){
	...
	if(d.raamhall.s===1) warnings.push('Raam Hall OPEN')
	if(d.raamkeuken.s===1) warnings.push('Raam Keuken OPEN')
...
function syncs(){
	...
	html += '<button onclick="ajaxcontrol(\'runsync\',\'runsync\',\'syncfotos\');setView(\'floorplan\');" class="btn huge">OneDrive - Foto\'s Beitem</button>'
...
function heating(){
	let html='<div id="message" class="dimmer"><div class="overlay-content">'
	if(d.heating.s==3) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/Gas.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'3\');setView(\'floorplanheating\');">Gas heating</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/Gas.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'3\');setView(\'floorplanheating\');">Gas heating</button>'
	if(d.heating.s==2) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/GasAirco.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'2\');setView(\'floorplanheating\');">&nbsp;Gas-Airco heating</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/GasAirco.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'2\');setView(\'floorplanheating\');">&nbsp;Gas-Airco heating</button>'
	if(d.heating.s==1) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/Cooling_red.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'1\');setView(\'floorplanheating\');">Airco heating</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/Cooling_red.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'1\');setView(\'floorplanheating\');">Airco heating</button>'
	if(d.heating.s==0) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/close.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'0\');setView(\'floorplanheating\');">Neutral</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/close.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'0\');setView(\'floorplanheating\');">Neutral</button>'
	if(d.heating.s==-1) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/Cooling_grey.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'-1\');setView(\'floorplanheating\');">Passive cooling</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/Cooling_grey.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'-1\');setView(\'floorplanheating\');">Passive cooling</button>'
	if(d.heating.s==-2) html+='<button class="btn btna huge" style="display:inline-block;background-image:url(images/Cooling.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'-2\');setView(\'floorplanheating\');">Airco cooling</button>'
	else html+='<button class="btn huge" style="display:inline-block;background-image:url(images/Cooling.png);background-repeat:no-repeat;background-position:center left 20px;" onclick="ajaxcontrol(\'heating\',\'heating\',\'-2\');setView(\'floorplanheating\');">Airco cooling</button>'
	html+='</div>'
	html+='</div>'
	html+='<button class="close-btn" onclick="setView(\'floorplanheating\');">✕</button>';
	setHTML('floorplantemp',html);
