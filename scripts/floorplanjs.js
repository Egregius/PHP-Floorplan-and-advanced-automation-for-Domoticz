						...
						if(device=="Weg"){
							...
							try{
								 if(device=="diepvries_temp"){
									...
									if($icon>=0.4)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendred.png" height="56px" width="15px"></div>';
									else if($icon>=0.3)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendred.png" height="42px" width="15px"></div>';
									else if($icon>=0.2)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendred.png" height="28px" width="15px"></div>';
									else if($icon>=0.1)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendred.png" height="14px" width="15px"></div>';
									...
									else if($icon<=-0.4)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendblue.png" height="56px" width="15px"></div>';
									else if($icon<=-0.3)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendblue.png" height="42px" width="15px"></div>';
									else if($icon<=-0.2)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendblue.png" height="28px" width="15px"></div>';
									else if($icon<=-0.1)html='<div class="fix" style="top:10px;left:13px;"><img src="https://home.egregius.be/images/trendblue.png" height="14px" width="15px"></div>';
