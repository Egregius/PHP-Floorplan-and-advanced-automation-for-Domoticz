...
function setpoint(device){
	...
	if(heatingset==2){
		...
		if(device=='badkamer'){
			...
			temps=[4,10,11,12,13,14,15,16,16.5,17,17.5,18,18.5,19,19.5,19.6,19.7,19.8,19.9,20,20.1,20.2,20.3,20.4,20.5];
		}else{
			temps=[10,10.5,11,11.5,12,12.5,13,13.5,14,14.5,15,15.5,16];
		}
	}else{
		temps=[20,20.5,21,21.5,22,22.5,23,23.5,24,24.5,25,25.5,26,26.5,27,27.5,28,28.5,29,29.5,33];
	}
