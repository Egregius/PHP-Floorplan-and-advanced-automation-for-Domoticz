                    ...
                    if(name=="t"){
                        ...
                        for (var i=0; i < arrayLength; i++) {
                            try{
                                ...
                                if(value=="Closed"){
                                    ...
                                    else if(tijd>$LastUpdateTime-14400)document.getElementById("t"+items[i]).style.color="#BBB";
                                    else if(tijd>$LastUpdateTime-21600)document.getElementById("t"+items[i]).style.color="#AAA";
                                    else if(tijd>$LastUpdateTime-28800)document.getElementById("t"+items[i]).style.color="#999";
                                    else if(tijd>$LastUpdateTime-36000)document.getElementById("t"+items[i]).style.color="#888";
                                    else if(tijd>$LastUpdateTime-43200)document.getElementById("t"+items[i]).style.color="#777";
                        ...
                        if(name=="Weg"){
                            ...
                            try{
                                ...
                                if(mode>30)elem.style.color="#FF0000";
                                else if(mode>28)elem.style.color="#FF2200";
                                else if(mode>26)elem.style.color="#FF4400";
                                else if(mode>24)elem.style.color="#FF6600";
...
function floorplan(){
    try{
        ...
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=alex\';" id="alex"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=eettafel\';" id="eettafel"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=kamer\';" id="kamer"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=ledluifel\';" id="ledluifel"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=lichtbadkamer\';" id="lichtbadkamer"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=terras\';" id="terras"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=tobi\';" id="tobi"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.php?setdimmer=zithoek\';" id="zithoek"></div>';
        ...
        html+='<div class="fix stamp" id="tpirliving"></div>';
        html+='<div class="fix stamp" id="tpirkeuken"></div>';
        html+='<div class="fix stamp" id="tpirgarage"></div>';
        ...
        html+='<div class="fix stamp" id="tRkeukenR"></div>';
        html+='<div class="fix stamp" id="tRtobi"></div>';
        html+='<div class="fix stamp" id="tRalex"></div>';
        html+='<div class="fix stamp" id="tRkamerL"></div>';
...
function floorplanmedia(){
    try{
        ...
        html+='<div class="fix z" onclick="location.href=\'floorplan.media.php?setdimmer=eettafel\';" id="eettafel"></div>';
        html+='<div class="fix z" onclick="location.href=\'floorplan.media.php?setdimmer=zithoek\';" id="zithoek"></div>';
