...
if (isset($_REQUEST['gpio'])) {
    ...
    if (($gpio==20||$gpio==21)&&($d['lichtbadkamer']['s']>0&&past('gasvandaag')<80&&past('watervandaag')<80)) {
        ...
        if ($euro>0&&round($euro*10000)%450==0) {
            douchewarn($euro, 85);
        } elseif ($euro>0&&round($euro*10000)%400==0) {
            douchewarn($euro, 80);
        } elseif ($euro>0&&round($euro*10000)%350==0) {
            douchewarn($euro, 75);
        } elseif ($euro>0&&round($euro*10000)%300==0) {
            douchewarn($euro, 70);
        } elseif ($euro>0&&round($euro*10000)%250==0) {
            douchewarn($euro, 65);
        } elseif ($euro>0&&round($euro*10000)%200==0) {
            douchewarn($euro, 60);
        } elseif ($euro>0&&round($euro*10000)%150==0) {
            douchewarn($euro, 55);
        } elseif ($euro>0&&round($euro*10000)%100==0) {
            douchewarn($euro, 50);
        } elseif ($euro>0&&round($euro*10000)%50==0) {
            douchewarn($euro, 45);
        }
    }
    echo 'ok';
