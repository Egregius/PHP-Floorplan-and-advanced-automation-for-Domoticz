...
if ($home) {
	...
	if ($udevice=='iPad') {
		...
		$args=array('width'=>480,'hide_legend'=>false,'responsive'=>false,'background_color'=>'#000','y_axis_text_style'=>array('fontSize'=>18,'color'=>'CCC'),'x_axis_text_style'=>array('fontSize'=>15,'color'=>'CCC'),'text_style'=>array('fontSize'=>12,'color'=>'CCC'));
	} elseif ($udevice=='Mac') {
	...
	$argstemp=array_merge($args, array('height'=>340,'colors'=>array('#FF0', '#F70'),'margins'=>array(0,0,50,50),'raw_options'=>'lineWidth:3,crosshair:{trigger:"both"}'));
	$argsregen=array_merge($args, array('chart'=>'ColumnChart','height'=>140,'colors'=>array('#33F'),'margins'=>array(0,0,0,50),'raw_options'=>'lineWidth:3,crosshair:{trigger:"both"},vAxis:{viewWindowMode:\'explicit\',viewWindow:{min:0,max:1}}'));
	$argswind=array_merge($args, array('height'=>120,'colors'=>array('#A66'),'margins'=>array(0,0,0,50),'raw_options'=>'lineWidth:3,crosshair:{trigger:"both"}'));
	echo '
	<body>
