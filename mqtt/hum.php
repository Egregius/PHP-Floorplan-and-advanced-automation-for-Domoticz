...
if ($udevice=='iPad') echo '
	<body style="width:1010px">
		<form action="/temp.php"><input type="submit" class="btn btn b2" value="Temperaturen"/></form>
		<form action="/hum.php"><input type="submit" class="btn btna b2" value="Humidity"/></form>';
elseif ($udevice=='iPhone') echo '
	<body style="width:450px">
		<div style="position:fixed;bottom:0px;left:0px;z-index:10;width:100%;height:60px;background-color:#000;">
		<form action="/temp.php"><input type="submit" class="btn btn b2" value="Temperaturen"/></form>
		<form action="/hum.php"><input type="submit" class="btn btna b2" value="Humidity"/></form>
		</div>';
	...
	<body style="width:100%">
		<form action="/temp.php"><input type="submit" class="btn btn b2" value="Temperaturen"/></form>
		<form action="/hum.php"><input type="submit" class="btna btn b2" value="Humidity"/></form>';
